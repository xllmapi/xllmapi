...
ALTER TABLE offerings ADD COLUMN IF NOT EXISTS daily_token_limit BIGINT NOT NULL DEFAULT 0;
ALTER TABLE offerings ADD COLUMN IF NOT EXISTS max_concurrency INT NOT NULL DEFAULT 0;
