...
const API_FORMATS = [
  {
    id: "xllmapi", url: "https://api.xllmapi.com/xllmapi/v1", tip: "xllmapi",
    icon: <span className="font-black text-[11px] leading-none">X</span>,
  },
  {
    id: "openai", url: "https://api.xllmapi.com/v1", tip: "OpenAI",
    // OpenAI logomark
  ...
  {
    id: "anthropic", url: "https://api.xllmapi.com/anthropic/v1", tip: "Anthropic",
    // Anthropic logomark
