const messages: Record<string, Record<string, string>> = {
  zh: {
    ...
    // Node preferences
    "nodePrefs.title": "节点偏好",
    "nodePrefs.settings": "偏好设置",
    "nodePrefs.allowDistributed": "允许分布式节点",
    "nodePrefs.allowDistributedDesc": "开启后，你的请求可能通过社区分布式节点路由",
    "nodePrefs.trustMode": "信任模式",
    "nodePrefs.trust.all": "信任所有",
    "nodePrefs.trust.all.desc": "允许所有经过审核的分布式节点",
    "nodePrefs.trust.by_supplier": "按供应者",
    "nodePrefs.trust.by_supplier.desc": "仅信任你选择的供应者的节点",
    "nodePrefs.trust.by_offering": "按服务",
    "nodePrefs.trust.by_offering.desc": "仅信任你加入的连接池中的服务",
    "nodePrefs.save": "保存",
    "nodePrefs.saving": "保存中…",
    "nodePrefs.saved": "设置已保存",
    "nodePrefs.connectionPool": "连接池",
    "nodePrefs.noPool": "暂未加入任何连接池",
    "nodePrefs.leave": "退出",
  ...
  en: {
    ...
    // Node preferences
    "nodePrefs.title": "Node Preferences",
    "nodePrefs.settings": "Preferences",
    "nodePrefs.allowDistributed": "Allow Distributed Nodes",
    "nodePrefs.allowDistributedDesc": "When enabled, your requests may be routed through community distributed nodes",
    "nodePrefs.trustMode": "Trust Mode",
    "nodePrefs.trust.all": "Trust All",
    "nodePrefs.trust.all.desc": "Allow all reviewed distributed nodes",
    "nodePrefs.trust.by_supplier": "By Supplier",
    "nodePrefs.trust.by_supplier.desc": "Only trust nodes from suppliers you select",
    "nodePrefs.trust.by_offering": "By Offering",
    "nodePrefs.trust.by_offering.desc": "Only trust offerings in your connection pool",
    "nodePrefs.save": "Save",
    "nodePrefs.saving": "Saving…",
    "nodePrefs.saved": "Preferences saved",
    "nodePrefs.connectionPool": "Connection Pool",
    "nodePrefs.noPool": "Not joined any connection pools",
    "nodePrefs.leave": "Leave",
