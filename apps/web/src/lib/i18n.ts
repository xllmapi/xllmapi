const messages: Record<string, Record<string, string>> = {
  zh: {
    ...
    // Nodes page
    "nodes.title": "节点管理",
    "nodes.createToken": "创建连接令牌",
    "nodes.tokenLabel": "令牌标签",
    "nodes.tokenLabelPlaceholder": "例如: my-server-1",
    "nodes.create": "创建",
    "nodes.creating": "创建中…",
    "nodes.tokenCreated": "令牌创建成功",
  ...
  en: {
    ...
    "nodes.createToken": "Create Connection Token",
    "nodes.tokenLabel": "Token Label",
    "nodes.tokenLabelPlaceholder": "e.g. my-server-1",
    "nodes.create": "Create",
    "nodes.creating": "Creating…",
    "nodes.tokenCreated": "Token created successfully",
    "nodes.copyTokenWarning": "Copy this token now. You won't be able to see it again.",
    "nodes.tokens": "Connection Tokens",
    "nodes.noTokens": "No tokens yet",
    "nodes.revoke": "Revoke",
